...
function ClientCreate() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      // Enviamos los datos para crear el nuevo cliente
      ...
      // Redirige a la lista de clientes después de la creación
      navigate('/clientes');
    } catch (err) {
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-semibold text-gray-800 mb-6">Crear Cliente</h1>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="px-4 py-2 bg-blue-500 text-white">Crear Cliente</button>
      </form>
    </div>
  );
}
