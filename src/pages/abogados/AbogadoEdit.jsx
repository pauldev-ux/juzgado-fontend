...
function AbogadoEdit() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`http://localhost:3001/api/abogados/update/${id}`, {
        nombre,
        apellido,
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-semibold text-gray-800 mb-6">Editar Abogado</h1>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="px-4 py-2 bg-blue-500 text-white">Actualizar Abogado</button>
      </form>
    </div>
  );
}
